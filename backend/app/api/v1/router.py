...
from .endpoints import health, models, metrics, query, prompts, analyzer, decision, observability

api_router = APIRouter()

api_router.include_router(health.router, tags=["Health"])
api_router.include_router(prompts.router, tags=["Prompt Gateway"])
api_router.include_router(analyzer.router, tags=["Query Analyzer"])
